...
import '@elden/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0xffa2c5f53dc3f7b5a48255dfa2ea6a8429535c365cbec5308a761d92c2cb9775; // scroll sepolia
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x770f196794b909661ebcbcbc6fce2549f2941b7f574c8d03123f305d7761c719;
    ...
    /// @param deployer The EldenSwap V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (IEldenV3Pool) {
        return IEldenV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid EldenSwap V3 Pool
    /// @param deployer The contract address of the EldenSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (IEldenV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (IEldenV3Pool pool)
    {
        pool = IEldenV3Pool(computeAddress(deployer, poolKey));
