...
contract RaitoPoolFactory is Ownable, IRaitoPoolFactory {
  ...
  IEldenStakeToken public eldenStakeToken; // eldenStakeToken contract's address
  ...
  constructor(IEldenToken _eldenToken, IEldenStakeToken eldenStakeToken_, address emergencyRecoveryAddress_, address feeAddress_){
  ...
  function createNitroPool(
    ...
    nitroPool = address(
      new RaitoPool(
        eldenToken, eldenStakeToken, msg.sender, INFTPool(nftPoolAddress),
